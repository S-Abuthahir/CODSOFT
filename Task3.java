...
class ATM implements ActionListener{
    ...
    public void deposit(){
        ...
        amount.setBounds(250,100,200,50);   amount.setFont(fontNum);
        JButton submit = new JButton("Submit");
        submit.setFont(fontNum);    submit.setBackground(Color.lightGray);
        submit.setBounds(200,200,200,50);
        JButton prev = new JButton("Previous page");
        prev.setFont(fontNum);  prev.setBackground(Color.lightGray);
    ...
    public void withdraw(){
        ...
        withdrawFrame.add(lb);withdrawFrame.add(amount);withdrawFrame.add(submit);withdrawFrame.add(prev);
    ...
    public void checkBalance(){
        ...
        show1.setBounds(200,200,100,50);
        JLabel show2 = new JLabel();
        show2.setFont(fontNum);
        show2.setText(""+account.accountbalance);
        show2.setBounds(300,200,200,50);
        JButton prev = new JButton("Previous page");
        prev.setBounds(200,300,200,50);
        prev.setFont(fontNum);prev.setBackground(Color.lightGray);
        prev.addActionListener(this);
        balanceFrame.add(show1);balanceFrame.add(show2);balanceFrame.add(prev);
    ...
    public void mainPage(BankAccount account){
        ...
        main.add(welcome);main.add(accno);main.add(depositb);main.add(withdrawb);main.add(balanceb);
        main.setLayout(null);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getActionCommand().equals("Deposit")){main.setVisible(false);deposit();}
        else if(e.getActionCommand().equals("Withdraw")){main.setVisible(false);withdraw();}
        else if(e.getActionCommand().equals("Balance")){main.setVisible(false);checkBalance();}
...
public class Task3 {
    public static void main(String[] args) {
        ATM atm = new ATM();
        atm.mainPage(new BankAccount(863484984L,50000,"User1"));
    }
}
